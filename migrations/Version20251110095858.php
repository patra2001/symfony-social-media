 ...
 */
final class Version20251110095858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE states ADD country_id INT DEFAULT NULL, CHANGE id id INT AUTO_INCREMENT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE states ADD state_code VARCHAR(100) DEFAULT NULL, ADD country_code CHAR(2) DEFAULT NULL, CHANGE id id INT UNSIGNED AUTO_INCREMENT DEFAULT NULL');
